...
import { QueueProvider, QueueStats, QueueToolbar, TaskCard, TaskRow, selectQueueStats, selectVisibleTasks, useQueue, type QueueControls } from "@/features/generation-queue";
...
function GenerationQueueContent() {
  const { state, cancelTask, retryTask, deleteTask } = useQueue();
